...
import {
	...
	// OutputEvent, ProgressStartEvent, ProgressUpdateEvent, ProgressEndEvent,
	// InvalidatedEvent,
	// Thread, StackFrame, Scope,
	// Source, Handles,
	Breakpoint
	//, MemoryEvent
...
import { MockRuntime, IRuntimeBreakpoint, FileAccessor
	// , RuntimeVariable, timeout, IRuntimeVariableType
} from './mockRuntime';
...
export class MockDebugSession extends LoggingDebugSession {
	...
	protected async launchRequest(response: DebugProtocol.LaunchResponse, args: ILaunchRequestArguments) {
		...
		await this._runtime.start(args.program, true/*!!args.stopOnEntry*/, !args.noDebug);
